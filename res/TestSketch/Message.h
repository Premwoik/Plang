...
public:
	enum CODE {TEST = 200, SET_LOW = 100, SET_HIGH = 101, SET_TIME_DIMMER = 102, SET_PWM = 105, READ_TERM = 110, READ_POWER = 111, READ_INPUTS = 112, INPUTS_RAPORT = 150, ACTIVE_INPUTS = 151, UNKNOWN = 0};
