...
testInvokeGenClassMethod = do
  ...
  let expectedAST = [IFile "invokeGenClassMethodExample" "res/tests/function/invokeGenClassMethodExample.mard" (AST [ClassExpr 0 "Obj" ["T"] [ClassAssign 18 (ScopeMark 18 "this" (TypedVar (VName "this___i") VAuto Nothing Nothing)) (VGen "T") Nop,Constructor 25 "Obj" [FunArg (VGen "T") "args___i"] [AssignFn 41 (ScopeMark 41 "this" (TypedVar (VName "this___i") (VGen "T") Nothing Nothing)) VBlank (TypedVar (VName "args___i") (VClass (VName "T") []) Nothing Nothing)],Method 55 "getConst" (VGen "T") [] [ReturnFn 76 (Just (TypedVar (VName "this___i") (VGen "T") Nothing Nothing))]],Function 83 "testFunc" [] VVoid [FunArg (VClass (VName "Obj") []) "args___a"] [AssignFn 112 (TypedVar (VName "o") VAuto Nothing Nothing) (VClass (VName "Obj") [VGenPair "T" VInt]) (TypedVar (VName "Obj") (VClass (VName "Obj") [VGenPair "T" VInt]) (Just [IntConst 125 1]) Nothing),OtherFn 130 (TypedVar (VName "o") (VClass (VName "Obj") [VGenPair "T" VInt]) Nothing (Just (TypedVar (VName "getConst") VInt (Just []) Nothing))),Pass]])]
