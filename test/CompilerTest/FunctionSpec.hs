...
testInvokeGen2ClassMethod = do
  ...
  let expectedAST = [IFile "invokeGenClassMethodExample2" "res/tests/function/invokeGenClassMethodExample2.mard" (AST [ClassExpr 0 "Obj" ["T"] [] [ClassAssign {classAssignOffset = 18, classAssignLeft = ScopeMark 18 "this" (TypedVar (VName "this___i") VAuto Nothing Nothing), classAssignType = VGen "T", classAssignDetails = MethodDetails {visibilityMD = "public", isOverrideMD = False, parentNameMD = ""}, classAssignRight = Nop},Constructor {constructorOffset = 25, constructorName = "Obj", constructorArgs = [FunArg (VGen "T") "args___i"], constructorBody = [AssignFn 41 (ScopeMark 41 "this" (TypedVar (VName "this___i") (VGen "T") Nothing Nothing)) VBlank (TypedVar (VName "args___i") (VGen "T") Nothing Nothing)]},Method {methodOffset = 55, methodName = "getConst", methodRet = VGen "T", methodArgs = [], methodDetails = MethodDetails {visibilityMD = "public", isOverrideMD = False, parentNameMD = "Obj"}, methodBody = [ReturnFn 76 (Just (TypedVar (VName "this___i") (VGen "T") Nothing Nothing))]}],ClassExpr 83 "Item" ["T"] [] [Constructor {constructorOffset = 102, constructorName = "Item", constructorArgs = [], constructorBody = [Pass]},Method {methodOffset = 122, methodName = "get", methodRet = VInt, methodArgs = [], methodDetails = MethodDetails {visibilityMD = "public", isOverrideMD = False, parentNameMD = "Item"}, methodBody = [ReturnFn 140 (Just (IntConst 144 0))]}],Function 147 "testFunc" [] VVoid [] [AssignFn 169 (TypedVar (VName "o") VAuto Nothing Nothing) (VClass (VName "Obj") [VGenPair "T" (VPointer (VClass (VName "Item") [VInt]) SharedPtr)]) (TypedVar (VName "Obj") (VClass (VName "Obj") [VGenPair "T" (VPointer (VClass (VName "Item") [VInt]) SharedPtr)]) (Just [TypedVar (VName "Item") (VClass (VName "Item") [VInt]) (Just []) Nothing]) Nothing),OtherFn 203 (TypedVar (VName "o") (VClass (VName "Obj") [VGenPair "T" (VGenPair "T" (VPointer (VClass (VName "Item") [VInt]) SharedPtr))]) Nothing (Just (TypedVar (VName "getConst") (VGenPair "T" (VPointer (VClass (VName "Item") [VInt]) SharedPtr)) (Just []) Nothing))),Pass]])]
...
testInvokeGenClassMethod = do
  ...
  let expectedAST = [IFile "invokeGenClassMethodExample" "res/tests/function/invokeGenClassMethodExample.mard" (AST [ClassExpr 0 "Obj" ["T"] [] [ClassAssign {classAssignOffset = 18, classAssignLeft = ScopeMark 18 "this" (TypedVar (VName "this___i") VAuto Nothing Nothing), classAssignType = VGen "T", classAssignDetails = MethodDetails {visibilityMD = "public", isOverrideMD = False, parentNameMD = ""}, classAssignRight = Nop},Constructor {constructorOffset = 25, constructorName = "Obj", constructorArgs = [FunArg (VGen "T") "args___i"], constructorBody = [AssignFn 41 (ScopeMark 41 "this" (TypedVar (VName "this___i") (VGen "T") Nothing Nothing)) VBlank (TypedVar (VName "args___i") (VGen "T") Nothing Nothing)]},Method {methodOffset = 55, methodName = "getConst", methodRet = VGen "T", methodArgs = [], methodDetails = MethodDetails {visibilityMD = "public", isOverrideMD = False, parentNameMD = "Obj"}, methodBody = [ReturnFn 76 (Just (TypedVar (VName "this___i") (VGen "T") Nothing Nothing))]}],Function 83 "testFunc" [] VVoid [FunArg (VClass (VName "Obj") []) "args___a"] [AssignFn 112 (TypedVar (VName "o") VAuto Nothing Nothing) (VClass (VName "Obj") [VGenPair "T" VInt]) (TypedVar (VName "Obj") (VClass (VName "Obj") [VGenPair "T" VInt]) (Just [IntConst 125 1]) Nothing),OtherFn 130 (TypedVar (VName "o") (VClass (VName "Obj") [VGenPair "T" (VGenPair "T" VInt)]) Nothing (Just (TypedVar (VName "getConst") (VGenPair "T" VInt) (Just []) Nothing))),Pass]])]
...
testInvokeClassMethod = do
  ...
  let expectedAST =  [IFile "invokeClassMethodExample" "res/tests/function/invokeClassMethodExample.mard" (AST [ClassExpr 0 "Obj" [] [] [Constructor {constructorOffset = 16, constructorName = "Obj", constructorArgs = [], constructorBody = [Pass]},Method {methodOffset = 35, methodName = "getConst", methodRet = VInt, methodArgs = [], methodDetails = MethodDetails {visibilityMD = "public", isOverrideMD = False, parentNameMD = "Obj"}, methodBody = [ReturnFn 58 (Just (IntConst 62 1))]}],Function 65 "testFunc" [] VVoid [FunArg (VClass (VName "Obj") []) "args___a"] [AssignFn 94 (TypedVar (VName "o") VAuto Nothing Nothing) (VClass (VName "Obj") []) (TypedVar (VName "Obj") (VClass (VName "Obj") []) (Just []) Nothing),OtherFn 106 (TypedVar (VName "o") (VClass (VName "Obj") []) Nothing (Just (TypedVar (VName "getConst") VInt (Just []) Nothing))),Pass]])]
